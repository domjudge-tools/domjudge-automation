...
import domjudgeService from '../services/domjudgeService';
import {
  generateUniqueId,
  generatePassword,
  generateUsername,
...
export async function createTeam(
  req: Request<{}, CreateTeamResponse, CreateTeamRequest>,
...
export async function createTeamsBulk(
  req: Request<{}, CreateTeamsBulkResponse, CreateTeamsBulkRequest>,
  res: Response<CreateTeamsBulkResponse>
): Promise<void> {
  try {
    ...
    const results: CreateTeamResponse[] = [];
